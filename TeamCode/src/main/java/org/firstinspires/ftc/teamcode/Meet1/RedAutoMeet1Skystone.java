...
public class RedAutoMeet1Skystone extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        robot1.grabbythingy.setPosition(0.3);
        strafe(350, 0.5);
        ...
        strafe(-275, 0.5);
        NumberOfMMforward = 0;
        while (opModeIsActive() && (sensorRange.getDistance(DistanceUnit.CM) > 10)) {
            telemetry.addData("range", String.format("%.01f cm", sensorRange.getDistance(DistanceUnit.CM)));
            straightMM(10, 0.5);
            robot1.Squishy1.setPower(0.5);
            robot1.Squishy2.setPower(-0.5);
        ...
        strafe(275, 0.5);
        rotate(180, 0.5);
        int actualMM1 = NumberOfMMforward*10 + 300;
        straightMM(actualMM1, 0.5);
        while (opModeIsActive() & sensorRange.getDistance(DistanceUnit.CM) < 30) {
            robot1.Squishy1.setPower(-0.5);
            robot1.Squishy2.setPower(0.5);
        }
        straightMM(-100, 0.5);
