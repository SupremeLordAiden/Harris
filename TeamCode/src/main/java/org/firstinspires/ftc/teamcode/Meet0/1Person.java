...
@TeleOp(name="1 Person", group="Linear Opmode")
...
public class OnePerson extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        robot1.rightServo.setPosition(0.5);
        ...
        while (opModeIsActive()) {
            ...
            */
            ...
            if (gamepad1.x) {
                robot1.leftServo.setPosition(0.2);
                robot1.rightServo.setPosition(0.8);
            }
            if (gamepad1.b) {
                robot1.leftServo.setPosition(0.32);
                robot1.rightServo.setPosition(0.7);
            }
            double servoPositionRacPinion = -gamepad2.left_stick_y;
            robot1.RackPinionServo.setPower(servoPositionRacPinion);
